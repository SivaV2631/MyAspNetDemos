...
namespace Restaurant1.Areas.RestMgmt.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,OrderName,OrderStatus,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderName,OrderStatus,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
