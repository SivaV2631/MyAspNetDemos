...
namespace JobPortal2.Areas.PortalMgmt.Controllers
{
    ...
    public class PostJobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostJobId,CompanyId,JobTitle,Vacancies,PostCreatedAt,LastDate,Qualification,MinSalary,MaxSalary,Location,WebUrl,JoRequirementId,JobStatusId,JobDescription,JobNatureId")] PostJob postJob)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostJobId,CompanyId,JobTitle,Vacancies,PostCreatedAt,LastDate,Qualification,MinSalary,MaxSalary,Location,WebUrl,JoRequirementId,JobStatusId,JobDescription,JobNatureId")] PostJob postJob)
        {
