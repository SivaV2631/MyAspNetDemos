...
namespace MyJobPortal.Areas.PortalMgmt.Controllers
{
    ...
    public class UserTablesController : Controller
    {
        ...
        {
            ViewData["UserTypeId"] = new SelectList(_context.AccountStatuses, "AccountStatusId", "AccountStatusName");
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Password,EmailAddress,ContactNo,UserTypeId,AccountStatusId")] UserTable userTable)
        {
            ...
            ViewData["UserTypeId"] = new SelectList(_context.AccountStatuses, "AccountStatusId", "AccountStatusName", userTable.UserTypeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Password,EmailAddress,ContactNo,UserTypeId,AccountStatusId")] UserTable userTable)
        {
