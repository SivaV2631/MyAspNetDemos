...
namespace JobPortal1.Areas.PortalMgmt.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,ContactNo,EmailAddress,Logo,Description")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,ContactNo,EmailAddress,Logo,Description")] Company company)
        {
