...
namespace JobPortal1.Areas.PortalMgmt.Controllers
{
    ...
    public class JobRequirementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobRequirementId,JobRequirementTitle")] JobRequirement jobRequirement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobRequirementId,JobRequirementTitle")] JobRequirement jobRequirement)
        {
