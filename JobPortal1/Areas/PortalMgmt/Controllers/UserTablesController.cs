...
namespace JobPortal1.Areas.PortalMgmt.Controllers
{
    ...
    public class UserTablesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.UserTables.Include(u => u.AccountStatus).Include(u => u.UserType);
        ...
        {
            ViewData["AccountStatusId"] = new SelectList(_context.AccountStatuses, "AccountStatusId", "AccountStatusName");
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Password,ConfirmPassword,EmailAddress,ContactNo,UserTypeId,AccountStatusId")] UserTable userTable)
        {
            ...
            ViewData["AccountStatusId"] = new SelectList(_context.AccountStatuses, "AccountStatusId", "AccountStatusName", userTable.AccountStatusId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Password,ConfirmPassword,EmailAddress,ContactNo,UserTypeId,AccountStatusId")] UserTable userTable)
        {
