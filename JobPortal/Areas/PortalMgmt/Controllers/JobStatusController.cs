...
namespace JobPortal.Areas.PortalMgmt.Controllers
{
    ...
    public class JobStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JobStatusId,JobStatusName")] JobStatus jobStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobStatusId,JobStatusName")] JobStatus jobStatus)
        {
