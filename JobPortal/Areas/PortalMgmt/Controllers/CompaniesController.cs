...
namespace JobPortal.Areas.PortalMgmt.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,ContactNo,EmailAddress,Logo,Description,UserId")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,ContactNo,EmailAddress,Logo,Description,UserId")] Company company)
        {
